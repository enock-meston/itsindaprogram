...
<html lang="en">
    <head>
        <title>Enginner ORCP Page</title>
        <meta charset="utf-8">
                                          ...
                                          <a href="citizens-list.php">  
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    ...
                                                    $query = mysqli_query($con, "SELECT * from tblcitizen WHERE Sector='$sector' AND ActiveStatus= 1");
